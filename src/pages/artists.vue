<template lang="html">
	<div class="artists">
		<ul class="list">
			<router-link tag="li" :to="{name:'ArtistsDatails',params:{avatar:item.avatar_s500,name:item.name,ting_uid:item.ting_uid}}"  class="artist" v-for="(item,index) in artistsData" :key="index">
				<div class="pic">
